...
import {
  AttrUnitRecord, AttrUnitSearchParam,
  deleteByAttrId,
  queryAttrUnitPage,
...
const searchFormModel = ref<AttrUnitRecord>({} as AttrUnitRecord);
...
const reset = () => {
  searchFormModel.value = {} as AttrUnitRecord;
};
